...
PIE.Observable = function() {
    ...
    /**
     * Hash of function ids to their position in the observers lists, for fast lookup
     */
    this.indexes = {};
};
...
PIE.Tokenizer = (function() {
    ...
    Tokenizer.prototype = {
        ...
        /**
         * Return a lists of tokens from the current position until the given function returns
         * true. The final token will not be included in the lists.
...
PIE.RootRenderer = PIE.RendererBase.newRenderer( {
    ...
    /**
     * Remove a VmlShape from the DOM and also from the internal lists of rendered shapes.
     */
...
PIE.BackgroundRenderer = PIE.RendererBase.newRenderer( {
    ...
    addLinearGradient: function( shape, info ) {
        ...
        // Add all the stops to the VML 'colors' lists, including the first and last stops.
    ...
    function Element( el ) {
        ...
        function init() {
            if( !initialized ) {
                ...
                if( lazy && ( bounds = boundsInfo.getBounds() ) && ( docEl = doc.documentElement || doc.body ) &&
                    ...
                    // Add to lists of polled elements when -pie-poll:true
                    if( poll ) {
        ...
        function destroy() {
            if( !destroyed ) {
                ...
                // Remove from lists of polled elements in IE8
                if( poll ) {
