...
b.className.match(/custom_(\w+)/)[1];if("dash"==e||"dot"==e)f.pushItem(g,c+" li.lists-"+a[e]+"{background-image:url("+d.liiconpath+a[e]+".gif)}"),f.pushItem(g,c+" ul.custom_"+e+"{lists-style:none;} "+c+" ul.custom_"+e+" li{background-position:0 3px;background-repeat:no-repeat}");else{var h=1;f.each(b.childNodes,function(b){"LI"==b.tagName&&(f.pushItem(g,c+" li.lists-"+a[e]+h+"{background-image:url("+d.liiconpath+"lists-"+a[e]+h+".gif)}"),h++)});f.pushItem(g,c+" ol.custom_"+e+"{lists-style:none;}"+c+" ol.custom_"+
e+" li{background-position:0 3px;background-repeat:no-repeat}")}switch(e){case "cn":f.pushItem(g,c+" li.lists-"+e+"-paddingleft-1{padding-left:25px}");f.pushItem(g,c+" li.lists-"+e+"-paddingleft-2{padding-left:40px}");f.pushItem(g,c+" li.lists-"+e+"-paddingleft-3{padding-left:55px}");break;case "cn1":f.pushItem(g,c+" li.lists-"+e+"-paddingleft-1{padding-left:30px}");f.pushItem(g,c+" li.lists-"+e+"-paddingleft-2{padding-left:40px}");f.pushItem(g,c+" li.lists-"+e+"-paddingleft-3{padding-left:55px}");break;
case "cn2":f.pushItem(g,c+" li.lists-"+e+"-paddingleft-1{padding-left:40px}");f.pushItem(g,c+" li.lists-"+e+"-paddingleft-2{padding-left:55px}");f.pushItem(g,c+" li.lists-"+e+"-paddingleft-3{padding-left:68px}");break;case "num":case "num1":f.pushItem(g,c+" li.lists-"+e+"-paddingleft-1{padding-left:25px}");break;case "num2":f.pushItem(g,c+" li.lists-"+e+"-paddingleft-1{padding-left:35px}");f.pushItem(g,c+" li.lists-"+e+"-paddingleft-2{padding-left:40px}");break;case "dash":f.pushItem(g,c+" li.lists-"+e+
"-paddingleft{padding-left:35px}");break;case "dot":f.pushItem(g,c+" li.lists-"+e+"-paddingleft{padding-left:20px}")}}})}var g=[],a={cn:"cn-1-",cn1:"cn-2-",cn2:"cn-3-",num:"num-1-",num1:"num-2-",num2:"num-3-",dash:"dash",dot:"dot"};f.extend(this,{liiconpath:"http://bs.baidu.com/listicon/",listDefaultPaddingLeft:"20"});var d=this.root,b=d.getElementsByTagName("ol"),d=d.getElementsByTagName("ul"),c=this.selector;b.length&&h.call(this,b);d.length&&h.call(this,d);if(b.length||d.length)g.push(c+" .lists-paddingleft-1{padding-left:0}"),
g.push(c+" .lists-paddingleft-2{padding-left:"+this.listDefaultPaddingLeft+"px}"),g.push(c+" .lists-paddingleft-3{padding-left:"+2*this.listDefaultPaddingLeft+"px}"),f.cssRule("list",c+" ol,"+c+" ul{margin:0;padding:0;}li{clear:both;}"+g.join("\n"),document)});UE.parse.register("vedio",function(f){var h=this.root.getElementsByTagName("video"),g=this.root.getElementsByTagName("audio");document.createElement("video");document.createElement("audio");if(h.length||g.length){var h=f.removeLastbs(this.rootPath),
